...
require.config({
    paths: {
        'spidergl': 'lib/3d-hop/minimal/js/spidergl',
        'jquery': 'lib/3d-hop/minimal/js/jquery',
        'nexus': 'lib/3d-hop/minimal/js/nexus',
        'presenter-3dhop': 'lib/3d-hop/minimal/js/presenter',
        'ply': 'lib/3d-hop/minimal/js/ply',
        'trackball-sphere': 'lib/3d-hop/minimal/js/trackball_sphere',
        'trackball-turntable': 'lib/3d-hop/minimal/js/trackball_turntable',
        'trackball-turntable-pan': 'lib/3d-hop/minimal/js/trackball_turntable_pan',
        'trackball-pantilt': 'lib/3d-hop/minimal/js/trackball_pantilt',
        'init-3dhop': 'lib/3d-hop/minimal/js/init',
    },
    shim: {
        'spidergl': {
            exports: 'SpiderGL'
